...
def parse_args():
    ...
    parser.add_argument('--bpr_batch', type=int, default=4096, help="the batch size for bpr loss training procedure")
    ...
    parser.add_argument('--dataset', type=str, default='reviewer_rec',
                        help="all_dataset = ['lastfm', 'gowalla', 'yelp2018', 'amazon-book', 'aminer', 'citeulike','amazon', 'ml-1m', 'reviewer_rec']")
    parser.add_argument('--path', type=str, default="./checkpoints", help="path to save weights")
    parser.add_argument('--topks', nargs='?', default="[20, 5, 10, 50]", help="@k test list")
    ...
    parser.add_argument('--simple_model', type=str, default='none',
                        help='simple-rec-model, support [none, lgn-ide, gf-cf]')
