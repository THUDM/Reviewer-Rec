...
class LightGCN(BasicModel):
    ...
    def __init_weight(self):
        ...
        # self.embedding_user = torch.nn.Parameter(initializer(torch.empty(self.num_users, self.latent_dim)))
        # self.embedding_item = torch.nn.Parameter(initializer(torch.empty(self.num_items, self.latent_dim)))
    ...
    def getEmbedding(self, users, pos_items, neg_items):
        ...
        return users_emb, pos_emb, neg_emb, users_emb_ego, pos_emb_ego, neg_emb_ego, all_users, all_items
    
    def bpr_loss(self, users, pos, neg):
        (users_emb, pos_emb, neg_emb, userEmb0, posEmb0, negEmb0, all_users, all_items) = self.getEmbedding(users.long(), pos.long(), neg.long())
