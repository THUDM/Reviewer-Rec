...
class LastFM(BasicDataset):
    ...
    def __init__(self, path="../data/lastfm"):
        ...
        # (users,users)
        self.socialNet = sp.csr_matrix((np.ones(len(trustNet)), (trustNet[:, 0], trustNet[:, 1])),
...
class Loader(BasicDataset):
    ...
    def __init__(self, config=world.config, path="data/aminer"):
        # train or test
